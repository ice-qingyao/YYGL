...
import unittest
from pages.browse_person_page import BrowsePersonPage
import ddt
...
@ddt.ddt
class TestBrowsePerson(unittest.TestCase):
    ...
    '''
         ...
         '''
    # 从Excel表格中读取数据
    infos = ReadData.readExcel('mms_ok', '浏览经办人')
    ...
    @ddt.unpack
    @screenshot.add_pic
    def test_browse_person(self,true_text):
        # 获取pass的图片
