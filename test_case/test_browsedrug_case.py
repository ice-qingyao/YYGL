...
import unittest
from pages.browse_drug_page import BrowseDrugPage
import ddt
...
@ddt.ddt
class TestBrowseDrug(unittest.TestCase):
    ...
    '''
         ...
         '''
    # 从Excel表格中读取数据
    infos = ReadData.readExcel('mms_ok', '浏览药品信息')
    ...
    def test_browse_client(self,true_text):
        ...
        #测试浏览增加的顾客
        newlist = BrowseDrugPage().BrowseDrug()
